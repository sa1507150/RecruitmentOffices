...
* The following dependencies are not known to work with Spring Native: 'Rest Repositories, Spring Web Services, Oracle
  Driver, Spring Boot DevTools, MS SQL Server Driver, Apache Derby Database, Spring Configuration Processor'. As a
...
```
$ docker run --rm -p 8080:8080 RecruitmentOffices:0.0.1-SNAPSHOT
```
